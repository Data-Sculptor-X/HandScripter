"""
Django settings for handscripter project.
...
SECRET_KEY = 'django-insecure-fq!ltsvc!j7+6)n(fz7f&&%ng2iny&w4e(-%$9(9_l-(a_bqvf'
...
ROOT_URLCONF = 'handscripter.urls'
...
WSGI_APPLICATION = 'handscripter.wsgi.application'
